...
rm tmp/*
rm *.bmp
echo "Generating Patterns..." > tmp/script_status499.txt
...
cd patterns/
echo "Preparing Scan Solution..." > ../tmp/script_status499.txt
...
echo "Loading Patterns..." > ../tmp/script_status499.txt
count=0
for entry in *
do
case $entry in *.bmp)
...
echo "_?!!SCRIPT_COMPLETED!!?_" > tmp/script_status499.txt